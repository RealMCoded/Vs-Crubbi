...
class TitleState extends MusicBeatState
{
	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			{
				case 1:
					createCoolText(['Dave and Bambi Created by:']);
				case 2:
					createCoolText(["",'MoldyGH', 'MissingTextureMan101', 'Rapparep LOL']);
				case 3:
					createCoolText(["",'TheBuilderXD', 'CyndaquilDAC', 'Erizur']);
				case 4:
					createCoolText(["and uhhhhhh other cool people"]);
				case 5:
					deleteCoolText();
				case 6:
					createCoolText(['Insane Spirals created by:']);
				case 7:
					createCoolText([" ",'Patzi', 'KingMusics', 'stuartt_mcoded']);
				case 8:
					deleteCoolText();
					ngSpr.visible = false;
				case 9:
